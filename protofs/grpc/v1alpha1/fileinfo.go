...
func ToProtoFileInfo(fi fs.FileInfo) *filev1alpha1.FileInfo {
	return toProtoFileInfo(fi)
}

// FromProtoFileInfo converts a proto FileInfo to an fs.FileInfo.
func FromProtoFileInfo(fi *filev1alpha1.FileInfo) fs.FileInfo {
	return fromProtoFileInfo(fi)
}

func toProtoFileInfo(fi fs.FileInfo) *filev1alpha1.FileInfo {
	return &filev1alpha1.FileInfo{
		Name:    fi.Name(),
		Size:    fi.Size(),
		Mode:    filev1alpha1.FileMode(fi.Mode()),
